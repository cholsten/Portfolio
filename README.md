...
These projects offer a snapshot of my experience, and reflect the practical application of my skills in data analysis and workflow optimization. Each project highlights different aspects of my technical skills, and in-depth understanding of issues relevant to healthcare.

## Projects

- 📊[Analysis of ambulatory primary care appointments using Excel, SQL, and Power BI](https://github.com/cholsten/EHR-Appointment-Analysis)
...
## Technology & Skills
- Programming: Python for automation, application development, and data processing.
- Data Visualization: Power BI and Tableau to drive insight and support strategic decision-making.
- Data Management & Analysis: Excel and SQL for data extraction, transformation, and analysis. Strong interest in data governance, quality, and leveraging AI to optimize workflows and enhance decisions.
- Healthcare Expertise: Clinical workflows (inpatient, outpatient, home health), and experience with health insurance coding, billing, and claims processes.
